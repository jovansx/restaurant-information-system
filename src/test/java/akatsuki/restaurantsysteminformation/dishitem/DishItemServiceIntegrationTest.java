...
class DishItemServiceIntegrationTest {
    ...
    public void create_ValidDto_SavedObject() {
        DishItemCreateDTO dishItemCreateDTO = new DishItemCreateDTO(4L, 10, "Give me the coldest beer that you have. I'll give you a good tip.", 1L, null);
    ...
    public void update_ItemNotExist_ExceptionThrown() {
        ...
        Assertions.assertThrows(DishItemNotFoundException.class, () -> dishItemService.update(dto, 15L));
    }
