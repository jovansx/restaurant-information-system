...
public class ChefPage {
    ...
    public void ensureItemFromOnHoldIsMoved() {
        (new WebDriverWait(driver, Duration.ofSeconds(10)))
                .until(ExpectedConditions.numberOfElementsToBe(By.xpath("//*[@id=\"mat-list\"]/app-item[2]/mat-list-option"), 1));
    }
    ...
    public void ensureItemsAreDisplayed() {
        (new WebDriverWait(driver, Duration.ofSeconds(10)))
                .until(ExpectedConditions.numberOfElementsToBe(By.xpath("//*[@id=\"mat-list\"]/app-item/mat-list-option"), 3));
    }
}
