...
public class ItemControllerIntegrationTest {
    ...
    public void create_ValidDto_ObjectIsCreated() {
        ...
        ItemCreateDTO createDTO = new ItemCreateDTO("Juices", 400, "Lemon juice", "It is made from lemon.", null, ItemType.DRINK, List.of("Lemon"));
    ...
    public void create_CategoryDoesNotExist_ErrorNotFount() {
        ItemCreateDTO createDTO = new ItemCreateDTO("Chocolate", 400, "Lemon juice", "It is made from lemon.", null, ItemType.DRINK, List.of("Lemon"));
        ResponseEntity<String> res = restTemplate.postForEntity(URL_PREFIX, createDTO, String.class);
    ...
    public void update_ValidEntityAndIdFirst_SavedObject() {
        ...
        ItemUpdateDTO updateDTO = new ItemUpdateDTO("Juices", 400, "c6d7d3c8-2273-4343-a6dc-87efe43867fa", "Lemon juice", "It is made from lemon.", null, ItemType.DRINK, List.of("Lemon"));
    ...
    public void update_ValidEntityAndIdSecond_SavedObject() {
        ItemUpdateDTO updateDTO = new ItemUpdateDTO("Juices", 400, "9a191868-228d-4dbb-819f-ca615d29fefe", "Lemon juice", "It is made from lemon.", null, ItemType.DRINK, List.of("Lemon"));
    ...
    public void update_CategoryDoesNotExist_ExceptionThrown() {
        ItemUpdateDTO updateDTO = new ItemUpdateDTO("Chocolate", 400, "9a191868-228d-4dbb-819f-ca615d29fefe", "Lemon juice", "It is made from lemon.", null, ItemType.DRINK, List.of("Lemon"));
        ResponseEntity<String> res = restTemplate.exchange(URL_PREFIX + "/5", HttpMethod.PUT,
                new HttpEntity<>(updateDTO), String.class);
        Assertions.assertEquals(HttpStatus.NOT_FOUND, res.getStatusCode());
    }
    ...
    public void update_NotValidCode_ExceptionThrown() {
        ItemUpdateDTO updateDTO = new ItemUpdateDTO("Juices", 400, "9a191868-228d-4dbb-819f-ca615d29fddd", "Lemon juice", "It is made from lemon.", null, ItemType.DRINK, List.of("Lemon"));
        ResponseEntity<String> res = restTemplate.exchange(URL_PREFIX + "/5", HttpMethod.PUT,
                new HttpEntity<>(updateDTO), String.class);
