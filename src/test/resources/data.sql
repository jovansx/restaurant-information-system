insert into salary (created_at, value)
values ('2021-01-01T00:00:00.000', 1000),
...
insert into my_user (first_name, last_name, email_address, phone_number, type, is_deleted)
values ('John', 'Cena', 'johncena@gmail.com', '0611111111', 3, false),
...
insert into unregistered_user (id, pin_code)
values (1, '1111'),
       (2, '1112'),
       (3, '1113'),
       (4, '1114'),
...
insert into registered_user (id, username, password, role_id)
values (9, 'bradpitt', '$2a$04$DbLOb2nXmJyS4cryCilJC.G1xlMYVoKNg0KSyGgGv/QswcfLnTTvq', 1),
...
insert into my_user_salary (user_id, salary_id)
values (1, 1),
       (2, 2),
       (3, 3),
       (4, 4),
...
insert into item_components (item_id, components)
values (1, 'Apple'),
       (1, 'Sugar'),
       (2, 'Orange'),
       (2, 'Sugar'),
...
insert into price (created_at, value)
values ('2021-11-03T00:00:00.000', 5),
...
insert into item_prices (item_id, prices_id)
values (1, 1),
       (1, 2),
       (2, 3),
       (3, 4),
...
insert into my_order_item (active, created_at, deleted, notes, state)
values (true, '2021-11-30T10:05:00.000', false, null, 1),
...
insert into dish_item (id, amount, chef_id, item_id)
values (1, 1, null, 4),
       (2, 3, 3, 5),
       (3, 1, 3, 5),
       (4, 10, 3, 5);

insert into drink_item (amount, item_id)
values (1, 1),
       (2, 2),
       (3, 1),
       (2, 3),
...
insert into drink_items_drink_item_list (drink_items_id, drink_item_list_id)
values (5, 1),
       (5, 2),
       (6, 3),
       (7, 4),
...
insert into my_order (active, created_at, discarded, total_price, waiter_id)
values (true, '2021-01-31T00:00:00.000', false, 8, 1),
...
insert into my_order_dishes (order_id, dishes_id)
values (1, 1),
       (1, 2),
       (1, 3),
       (1, 4);

insert into my_order_drinks (order_id, drinks_id)
values (1, 5),
       (1, 6),
       (1, 7),
       (1, 8),
